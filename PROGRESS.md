...
- Aktif/berikut: **M8.2 Walk-forward/holdout**
- Bukti terakhir: 45 tes Python 3.12/PostgreSQL lokal lulus.
...
- M8 — Strategy validation: [x] M8.1 Freeze experiment — 45 tes; [ ] M8.2 Walk-forward/holdout; [ ] M8.3 Stress/report
