...
- Aktif/berikut: **M6.3 Restart/reconciliation**
- Bukti terakhir: 40 tes Python 3.12/PostgreSQL lokal lulus.
...
- M6 — Ledger/simulator: [x] M6.1 Intent/attempt — 39 tes; [x] M6.2 State machine — 40 tes; [ ] M6.3 Restart/reconciliation
