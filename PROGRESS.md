...
- Aktif/berikut: **M11.1 Gate/capital/policy**
- Bukti terakhir: 53 tes Python 3.12/PostgreSQL lokal lulus.
...
- M9 — Telegram/paper: **DONE; gate LULUS**
  - [x] M9.1 Allowlist/commands — 48 tes; [x] M9.2 Approval TTL — 49 tes; [x] M9.3 Forward paper — 50 tes
- M10 — Execution integration: **DONE; gate LULUS**
  - [x] M10.1 Quote/route — 51 tes; [x] M10.2 Decode/simulation — 52 tes; [x] M10.3 Signer boundary/status — 53 tes
