...
- Aktif/berikut: **M9.2 Approval TTL**
- Bukti terakhir: 48 tes Python 3.12/PostgreSQL lokal lulus.
...
- M9 — Telegram/paper: [x] M9.1 Allowlist/commands — 48 tes; [ ] M9.2 Approval TTL; [ ] M9.3 Forward paper
