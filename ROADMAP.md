...
| M7 Backtest | replay, costs, labels | IN_PROGRESS (M7.1–M7.2 done) |
...
M7.2 selesai; M7.3 label TP/SL/no-route adalah tugas berikutnya. Status/hitungan resmi ada di `PROGRESS.md`.
