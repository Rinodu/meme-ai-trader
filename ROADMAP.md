...
| M7 | Backtest dan label | 1. Replay waktu; 2. Cost model; 3. TP/SL/no-route labels | BT-001 | Tidak memakai future data; fill dan biaya eksplisit | IN_PROGRESS (M7.1–M7.2 done) |
