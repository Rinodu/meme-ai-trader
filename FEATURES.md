...
| EXEC-001 | Intent dan attempt execution disimpan dengan ID serta status awal terpisah. | VERIFIED | `tests/test_raw_events_integration.py` |

State machine dan reconciliation execution masih PLANNED di `ROADMAP.md`.
