...
class SimulationTests(unittest.TestCase):
    def test_payload_must_match_quote_authority_and_destination(self):
        quote = Quote("SOL", "mint", Decimal("1"), Decimal("2"), datetime(2026, 9, 16, tzinfo=timezone.utc), True)
        payload = {"input_token": "SOL", "output_token": "mint", "input_amount": Decimal("1"), "min_output": Decimal("2"), "authority": "wallet", "destination": "ata"}
