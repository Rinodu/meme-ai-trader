...
- M1–M5 selesai; M6.1 memverifikasi intent/attempt sebagai ledger simulator dengan guard no-execution.
- Tugas berikut: M6.2 state machine simulator di docs/tasks/CURRENT.md.
