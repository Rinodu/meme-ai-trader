...
- M1 selesai; M2.1–M2.2 raw data Signal Bot menyimpan dedup dan waktu availability dengan PostgreSQL lokal.
- Tugas berikut: M2.3 adapter Birdeye read-only di docs/tasks/CURRENT.md.
