...
- M1 selesai; M2.1–M2.3 raw data Signal Bot menyimpan dedup/waktu availability dan snapshot Birdeye read-only dengan PostgreSQL lokal.
- Tugas berikut: M2.4 quality dan reconciliation feed di docs/tasks/CURRENT.md.
