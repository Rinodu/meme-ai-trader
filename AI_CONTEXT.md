...
- M1–M3 selesai; M4.1–M4.2 memverifikasi fitur point-in-time dan signal expiry tanpa execution.
- Tugas berikut: M4.3 replay deterministik di docs/tasks/CURRENT.md.
