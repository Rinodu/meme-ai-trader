...
- M1–M8 selesai; Telegram Signal Bot memakai allowlist dan tidak memiliki approval buy/sell.
- Tugas berikut: M9.2 signal dan exit update Telegram di docs/tasks/CURRENT.md.
