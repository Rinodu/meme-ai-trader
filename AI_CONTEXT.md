...
- M1–M5 selesai; risk, reservation, dan control legacy terverifikasi sebagai simulator dengan guard no-execution.
- Tugas berikut: M6.1 intent/attempt simulator di docs/tasks/CURRENT.md.
