...
- M1–M6 selesai; M7.1 memverifikasi time replay yang hanya memakai availability `received_at`.
- Tugas berikut: M7.2 cost model simulator di docs/tasks/CURRENT.md.
