...
- M1 selesai: runtime hanya mendukung `collect_only`, `replay`, dan `paper_signal`; config gate serta suite 55/55 lulus.
- Tugas berikut: M2.1 schema/raw repository Signal Bot di docs/tasks/CURRENT.md.
