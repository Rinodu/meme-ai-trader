...
- M1–M6 selesai; ledger simulator mendukung recovery/reconciliation tanpa membuat execution capability.
- Tugas berikut: M7.1 time replay di docs/tasks/CURRENT.md.
