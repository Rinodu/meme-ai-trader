...
- M1–M5 selesai; M6.1–M6.2 memverifikasi ledger simulator dan lifecycle valid dengan guard no-execution.
- Tugas berikut: M6.3 restart/reconciliation simulator di docs/tasks/CURRENT.md.
