...
- M1–M2 selesai; M3.1 memverifikasi filter universe point-in-time dengan feed/umur/likuiditas/volume yang eksplisit.
- Tugas berikut: M3.2 security adapter di docs/tasks/CURRENT.md.
