...
- M1–M4 selesai; M5.1 memverifikasi sizing/exposure sebagai kalkulasi simulator tanpa execution.
- Tugas berikut: M5.2 reservation simulator di docs/tasks/CURRENT.md.
