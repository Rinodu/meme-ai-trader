...
- M1–M6 selesai; M7.1–M7.2 memverifikasi replay dan estimasi biaya sebagai simulator tanpa execution.
- Tugas berikut: M7.3 label TP/SL/no-route di docs/tasks/CURRENT.md.
