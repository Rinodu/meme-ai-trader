...
- Enam tes lulus pada runtime project dengan PostgreSQL nyata: lima regresi config M1 dan satu migration/round-trip M2.1. Serena mengenali simbol; Pyright Serena belum mengikuti `.venv` untuk resolusi import Psycopg. RTK belum tersedia.
