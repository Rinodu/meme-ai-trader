...
- M1–M4 selesai; M5.1–M5.2 memverifikasi sizing dan reservation sebagai simulator PostgreSQL tanpa execution.
- Tugas berikut: M5.3 exit/kill switch di docs/tasks/CURRENT.md.
