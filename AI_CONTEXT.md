...
- M1–M4 selesai; replay Signal Bot bersifat deterministik dan hanya memakai data yang tersedia pada waktu evaluasi.
- Tugas berikut: M5.1 sizing/exposure di docs/tasks/CURRENT.md.
